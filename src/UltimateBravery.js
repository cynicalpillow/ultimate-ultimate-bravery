  ...
  componentDidMount() {
    ...
    this.setState({ first_synergy: synergies[0] }, () => {
      ...
      images = images.map((image, index) =>
        <li key={index}>
          <img className="champion_image" src={process.env.PUBLIC_URL + image}/>
        </li>
      );
